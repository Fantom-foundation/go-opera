...
func (_m *MockNode) AddInternalTxn(_param0 inter.InternalTransaction) (hash.Transaction, error) {
...
func (_m *MockConsensus) StakeOf(peer hash.Peer) uint64 {
	ret := _m.ctrl.Call(_m, "StakeOf", peer)
	ret0, _ := ret[0].(uint64)
	return ret0
}

func (_mr *_MockConsensusRecorder) StakeOf(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "StakeOf", arg0)
}
