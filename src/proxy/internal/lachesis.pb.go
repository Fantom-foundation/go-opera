...
// source: internal/lachesis.proto
...
func (*ToServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{0}
}
...
func (*ToServer_Tx) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{0, 0}
}
...
func (*ToServer_Answer) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{0, 1}
}
...
func (*ToClient) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{1}
}
...
func (*ToClient_Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{1, 0}
}
...
func (*ToClient_Query) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{1, 1}
}
...
func (*ToClient_Restore) Descriptor() ([]byte, []int) {
	return fileDescriptor_83d5b4afa4ee5fba, []int{1, 2}
}
...
func init() { proto.RegisterFile("internal/lachesis.proto", fileDescriptor_83d5b4afa4ee5fba) }

var fileDescriptor_83d5b4afa4ee5fba = []byte{
	// 350 bytes of a gzipped FileDescriptorProto
	,
}
...
var _LachesisNode_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/lachesis.proto",
}
