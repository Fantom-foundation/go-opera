...
func (dst *ToServer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToServer.Merge(dst, src)
}
...
func (dst *ToServer_Tx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToServer_Tx.Merge(dst, src)
}
...
func (dst *ToServer_Answer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToServer_Answer.Merge(dst, src)
}
...
func (dst *ToClient) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToClient.Merge(dst, src)
}
...
func (dst *ToClient_Block) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToClient_Block.Merge(dst, src)
}
...
func (dst *ToClient_Query) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToClient_Query.Merge(dst, src)
}
...
func (dst *ToClient_Restore) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ToClient_Restore.Merge(dst, src)
}
