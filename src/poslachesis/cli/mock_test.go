...
func (m *MockConsensus) GetBalanceOf(arg0 hash.Peer) uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBalanceOf", arg0)
	ret0, _ := ret[0].(uint64)
	return ret0
}

// GetBalanceOf indicates an expected call of GetBalanceOf
func (mr *MockConsensusMockRecorder) GetBalanceOf(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBalanceOf", reflect.TypeOf((*MockConsensus)(nil).GetBalanceOf), arg0)
}
