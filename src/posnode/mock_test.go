...
func (_m *MockConsensus) GetBalance(_param0 hash.Peer) float64 {
	ret := _m.ctrl.Call(_m, "GetBalance", _param0)
	ret0, _ := ret[0].(float64)
	return ret0
}

func (_mr *_MockConsensusRecorder) GetBalance(arg0 interface{}) *gomock.Call {
