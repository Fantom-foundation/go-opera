...
func (_m *MockConsensus) GetTransactionCount(_param0 hash.Peer) uint64 {
	ret := _m.ctrl.Call(_m, "GetTransactionCount", _param0)
	ret0, _ := ret[0].(uint64)
	return ret0
}

func (_mr *_MockConsensusRecorder) GetTransactionCount(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetTransactionCount", arg0)
}
