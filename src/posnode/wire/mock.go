...
func (_m *MockNodeClient) GetEvent(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*Event, error) {
	_s := []interface{}{ctx, in}
	for _, _x := range opts {
		_s = append(_s, _x)
	}
...
func (_m *MockNodeServer) GetEvent(_param0 context.Context, _param1 *EventRequest) (*Event, error) {
