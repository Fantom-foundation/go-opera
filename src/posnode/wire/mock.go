...
func (m *MockNodeClient) GetEvent(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*Event, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockNodeClient) GetEventByHash(ctx context.Context, in *EventByHashRequest, opts ...grpc.CallOption) (*Event, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// GetEvent mocks base method
func (m *MockNodeServer) GetEvent(arg0 context.Context, arg1 *EventRequest) (*Event, error) {
	m.ctrl.T.Helper()
...
// GetEventByHash mocks base method
func (m *MockNodeServer) GetEventByHash(arg0 context.Context, arg1 *EventByHashRequest) (*Event, error) {
	m.ctrl.T.Helper()
