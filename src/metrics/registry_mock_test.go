...
func (m *MockRegistry) OnNew(f RegistryEachFunc) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnNew", f)
}

// OnNew indicates an expected call of OnNew
func (mr *MockRegistryMockRecorder) OnNew(f interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnNew", reflect.TypeOf((*MockRegistry)(nil).OnNew), f)
}
