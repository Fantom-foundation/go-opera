//go:generate mockgen -package=metrics -self_package=github.com/Fantom-foundation/go-lachesis/metrics -destination=registry_mock_test.go github.com/Fantom-foundation/go-lachesis/metrics Registry
