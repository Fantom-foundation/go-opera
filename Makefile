...
opera:
	...
	GOPROXY=$(GOPROXY) \
	go build \
	    -ldflags "-s -w -X github.com/cyberbono3/go-opera/cmd/opera/launcher.gitCommit=$${GIT_COMMIT} -X github.com/cyberbono3/go-opera/cmd/opera/launcher.gitDate=$${GIT_DATE}" \
	    -o build/opera \
	    ./cmd/opera
