...
import (
	...
	"github.com/cyberbono3/go-opera/integration/makegenesis"
	"github.com/cyberbono3/go-opera/inter"
	"github.com/cyberbono3/go-opera/inter/drivertype"
	"github.com/cyberbono3/go-opera/inter/iblockproc"
	"github.com/cyberbono3/go-opera/inter/ier"
	"github.com/cyberbono3/go-opera/inter/validatorpk"
	"github.com/cyberbono3/go-opera/opera"
	"github.com/cyberbono3/go-opera/opera/contracts/driver"
	"github.com/cyberbono3/go-opera/opera/contracts/driver/drivercall"
	...
	netinitcall "github.com/cyberbono3/go-opera/opera/contracts/netinit/netinitcalls"
	"github.com/cyberbono3/go-opera/opera/contracts/sfc"
	"github.com/cyberbono3/go-opera/opera/genesis"
	"github.com/cyberbono3/go-opera/opera/genesis/gpos"
...
func FakeGenesisStore(genesisKV, chainKV kv.RwDB, num idx.Validator, balance, stake *big.Int) *genesisstore.Store {
	return FakeGenesisStoreWithRules(genesisKV, chainKV, num, balance, stake, opera.FakeNetRules())
}

func FakeGenesisStoreWithRules(genesisKV, chainKV kv.RwDB, num idx.Validator, balance, stake *big.Int, rules opera.Rules) *genesisstore.Store {
	return FakeGenesisStoreWithRulesAndStart(genesisKV, chainKV, num, balance, stake, rules, 2, 1)
}

func FakeGenesisStoreWithRulesAndStart(genesisKV, chainKV kv.RwDB, num idx.Validator, balance, stake *big.Int, rules opera.Rules, epoch idx.Epoch, block idx.Block) *genesisstore.Store {
