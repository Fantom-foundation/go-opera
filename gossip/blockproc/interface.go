...
type EVM interface {
	Start(block iblockproc.BlockCtx, statedb *state.StateDB, reader evmcore.DummyChain, onNewLog func(*types.Log), net opera.Rules, vmConfig vm.Config, chainCfg *params.ChainConfig) EVMProcessor
}
